...
class ExitUrls implements WithExitUrls {
   ...
   * {@link ExitUrls::of ExitUrls#of(String, String, String)}
   ...
   * ({@link StatusReference::STATUS_QUERY_TOKEN_PARAM_NAME STATUS_QUERY_TOKEN_PARAM_NAME})
   * which contains a token required to {@link DirectClient::getStatus() DirectClient#getStatus(StatusReference)}
